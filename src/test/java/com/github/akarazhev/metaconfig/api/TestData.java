...
class TestData {
    ...
    static final String NEW_CONFIG = "New Config";

    Config getConfig(final Collection<Property> properties) {
    ...
    Config getConfigWithSubProperties(final String name) {
    ...
    Config getConfigWithProperties(final String name) {
    ...
    void assertEqualsConfig(final Config expected, final Config actual) {
    ...
    void assertEqualsProperty(final Config expectedConfig, final Config actualConfig) {
