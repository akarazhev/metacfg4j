...
-- Insert a property
INSERT INTO `PROPERTIES` (`ID`, `CONFIG_ID`, `NAME`, `CAPTION`, `DESCRIPTION`, `TYPE`, `VALUE`) VALUES
  (1, 1, 'Property', 'Caption', 'Description', 'BOOL', 'true');
-- Insert config attributes
...
-- Insert a property
INSERT INTO `PROPERTIES` (`ID`, `PROPERTY_ID`, `CONFIG_ID`, `NAME`, `CAPTION`, `DESCRIPTION`, `TYPE`, `VALUE`) VALUES
  (2, 1, 1, 'Sub-Property-1', 'Sub-Caption-1', 'Sub-Description-1', 'BOOL', 'true');
-- Insert config attributes
...
-- Insert a property
INSERT INTO `PROPERTIES` (`ID`, `PROPERTY_ID`, `CONFIG_ID`, `NAME`, `CAPTION`, `DESCRIPTION`, `TYPE`, `VALUE`) VALUES
  (3, 2, 1, 'Sub-Property-2', 'Sub-Caption-2', 'Sub-Description-2', 'BOOL', 'true');
-- Insert config attributes
